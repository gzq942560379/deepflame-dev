...
#include "eagerHPCGProcAgglomeration.H"
...
namespace Foam
{
    defineTypeNameAndDebug(eagerHPCGProcAgglomeration, 0);
...
Foam::eagerHPCGProcAgglomeration::eagerHPCGProcAgglomeration
(
...
bool Foam::eagerHPCGProcAgglomeration::agglomerate()
{
    if (debug)
    {
