...
#include "masterCoarsestHPCGProcAgglomeration.H"
...
namespace Foam
{
    defineTypeNameAndDebug(masterCoarsestHPCGProcAgglomeration, 0);

    addToRunTimeSelectionTable
    (
        HPCGProcAgglomeration,
        masterCoarsestHPCGProcAgglomeration,
        HPCGAgglomeration
    );
}
...
Foam::masterCoarsestHPCGProcAgglomeration::masterCoarsestHPCGProcAgglomeration
(
...
Foam::masterCoarsestHPCGProcAgglomeration::
~masterCoarsestHPCGProcAgglomeration()
{
...
bool Foam::masterCoarsestHPCGProcAgglomeration::agglomerate()
{
    if (debug)
    {
