...
#include "manualHPCGProcAgglomeration.H"
...
namespace Foam
{
    defineTypeNameAndDebug(manualHPCGProcAgglomeration, 0);

    addToRunTimeSelectionTable
    (
        HPCGProcAgglomeration,
        manualHPCGProcAgglomeration,
        HPCGAgglomeration
    );
}
...
Foam::manualHPCGProcAgglomeration::manualHPCGProcAgglomeration
(
...
Foam::manualHPCGProcAgglomeration::
~manualHPCGProcAgglomeration()
{
...
bool Foam::manualHPCGProcAgglomeration::agglomerate()
{
    if (debug)
    {
