...
namespace Foam
{
    defineTypeNameAndDebug(HPCGInterface, 0);
    defineRunTimeSelectionTable(HPCGInterface, lduInterface);
    defineRunTimeSelectionTable(HPCGInterface, Istream);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::HPCGInterface::HPCGInterface
(
    const label index,
...
void Foam::HPCGInterface::combine(const HPCGInterface& coarseGi)
{
...
Foam::tmp<Foam::labelField> Foam::HPCGInterface::interfaceInternalField
(
...
Foam::tmp<Foam::scalarField> Foam::HPCGInterface::agglomerateCoeffs
(
...
void Foam::HPCGInterface::write(Ostream& os) const
{
