...
namespace Foam
{
    defineTypeNameAndDebug(cyclicHPCGInterface, 0);
...
Foam::cyclicHPCGInterface::cyclicHPCGInterface
(
    const label index,
...
:
    HPCGInterface(index, coarseInterfaces),
    neighbPatchID_
    (
...
Foam::tmp<Foam::labelField> Foam::cyclicHPCGInterface::internalFieldTransfer
(
    const Pstream::commsTypes,
    const labelUList& iF
) const
{
    const cyclicHPCGInterface& nbr = neighbPatch();
...
void Foam::cyclicHPCGInterface::write(Ostream& os) const
{
