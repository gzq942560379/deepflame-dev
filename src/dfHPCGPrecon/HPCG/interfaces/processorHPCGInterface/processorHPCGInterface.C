...
namespace Foam
{
    defineTypeNameAndDebug(processorHPCGInterface, 0);
    addToRunTimeSelectionTable
    (
        HPCGInterface,
        processorHPCGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processorHPCGInterface::processorHPCGInterface
(
    const label index,
...
:
    HPCGInterface(index, coarseInterfaces, is),
    comm_(readLabel(is)),
...
void Foam::processorHPCGInterface::initInternalFieldTransfer
(
...
Foam::tmp<Foam::labelField> Foam::processorHPCGInterface::internalFieldTransfer
(
    const Pstream::commsTypes commsType,
    const labelUList& iF
) const
...
void Foam::processorHPCGInterface::write(Ostream& os) const
{
    HPCGInterface::write(os);
