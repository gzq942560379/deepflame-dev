...
#include "ELLGAMGPreconditioner.H"
#include <mpi.h>
...
namespace Foam
{
    defineTypeNameAndDebug(ELLGAMGPreconditioner, 0);

    ellMatrix::preconditioner::addsymMatrixConstructorToTable
    <ELLGAMGPreconditioner> addELLGAMGPreconditionerSymMatrixConstructorToTable_;

    ellMatrix::preconditioner::addasymMatrixConstructorToTable
    <ELLGAMGPreconditioner> addELLGAMGPreconditionerAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::ELLGAMGPreconditioner::ELLGAMGPreconditioner
(
...
void Foam::ELLGAMGPreconditioner::readControls()
{
    ELLGAMGSolver::readControls();
    nVcycles_ = controlDict_.lookupOrDefault<label>("nVcycles", 2);
}


void Foam::ELLGAMGPreconditioner::precondition
(
    scalarField& wA,
