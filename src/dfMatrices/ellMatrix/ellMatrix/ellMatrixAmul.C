...
) const
{
    ...
    if(row_block_size_ == 8 && BLOCK_TAIL == 0){
        ...
        for(label rbs = 0; rbs < row_; rbs += row_block_size_){
            ...
            ApsiPtr_offset[0] = diagPtr_offset[0] * psiPtr[rbs + 0];
            ApsiPtr_offset[1] = diagPtr_offset[1] * psiPtr[rbs + 1];
            ApsiPtr_offset[2] = diagPtr_offset[2] * psiPtr[rbs + 2];
            ApsiPtr_offset[3] = diagPtr_offset[3] * psiPtr[rbs + 3];
            ApsiPtr_offset[4] = diagPtr_offset[4] * psiPtr[rbs + 4];
            ApsiPtr_offset[5] = diagPtr_offset[5] * psiPtr[rbs + 5];
            ApsiPtr_offset[6] = diagPtr_offset[6] * psiPtr[rbs + 6];
            ApsiPtr_offset[7] = diagPtr_offset[7] * psiPtr[rbs + 7];
            ...
            for(label ellcol = 0; ellcol < max_count_; ++ellcol){
                ...
                ApsiPtr_offset[0] += off_diag_value_Ptr[index_ellcol_start + 0] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 0]];
                ApsiPtr_offset[1] += off_diag_value_Ptr[index_ellcol_start + 1] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 1]];
                ApsiPtr_offset[2] += off_diag_value_Ptr[index_ellcol_start + 2] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 2]];
                ApsiPtr_offset[3] += off_diag_value_Ptr[index_ellcol_start + 3] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 3]];
                ApsiPtr_offset[4] += off_diag_value_Ptr[index_ellcol_start + 4] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 4]];
                ApsiPtr_offset[5] += off_diag_value_Ptr[index_ellcol_start + 5] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 5]];
                ApsiPtr_offset[6] += off_diag_value_Ptr[index_ellcol_start + 6] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 6]];
                ApsiPtr_offset[7] += off_diag_value_Ptr[index_ellcol_start + 7] * psiPtr[off_diag_colidx_Ptr[index_ellcol_start + 7]];
            }
        }
    }else{
        #pragma omp parallel for
