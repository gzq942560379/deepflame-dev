...
Foam::autoPtr<Foam::ELLGAMGInterfaceField> Foam::ELLGAMGInterfaceField::New
(
...
)
{
    ...
    if (cstrIter == lduInterfaceFieldConstructorTablePtr_->end())
    {
        FatalErrorInFunction
            << "Unknown ELLGAMGInterfaceField type "
            << coupleType << nl
            << "Valid ELLGAMGInterfaceField types are :"
            << lduInterfaceFieldConstructorTablePtr_->sortedToc()
            << exit(FatalError);
    }

    return autoPtr<ELLGAMGInterfaceField>(cstrIter()(GAMGCp, fineInterface));
}
...
)
{
    ...
    return autoPtr<ELLGAMGInterfaceField>(cstrIter()(GAMGCp, doTransform, rank));
}
