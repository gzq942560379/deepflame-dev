...
#include "processorELLGAMGInterfaceField.H"
...
namespace Foam
{
    defineTypeNameAndDebug(processorELLGAMGInterfaceField, 0);
    addToRunTimeSelectionTable
    (
        ELLGAMGInterfaceField,
        processorELLGAMGInterfaceField,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processorELLGAMGInterfaceField::processorELLGAMGInterfaceField
(
...
:
    ...
    procInterface_(refCast<const processorELLGAMGInterface>(GAMGCp)),
    doTransform_(false),
    rank_(0)
{
...
void Foam::processorELLGAMGInterfaceField::initInterfaceMatrixUpdate
(
    scalarField&,
...
) const
{
    ...
    const_cast<processorELLGAMGInterfaceField&>(*this).updatedMatrix() = false;
}


void Foam::processorELLGAMGInterfaceField::updateInterfaceMatrix
(
    scalarField& result,
    const scalarField&,
...
) const
{
    ...
    const_cast<processorELLGAMGInterfaceField&>(*this).updatedMatrix() = true;
}
