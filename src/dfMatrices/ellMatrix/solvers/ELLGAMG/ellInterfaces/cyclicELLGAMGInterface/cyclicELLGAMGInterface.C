...
#include "cyclicELLGAMGInterface.H"
...
namespace Foam
{
    defineTypeNameAndDebug(cyclicELLGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        ELLGAMGInterface,
        cyclicELLGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::cyclicELLGAMGInterface::cyclicELLGAMGInterface
(
    const label index,
...
:
    ELLGAMGInterface(index, coarseInterfaces),
    neighbPatchID_
    (
...
:
    ELLGAMGInterface(index, coarseInterfaces, is),
...
Foam::tmp<Foam::labelField> Foam::cyclicELLGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes,
    const labelUList& iF
) const
{
    const cyclicELLGAMGInterface& nbr = neighbPatch();
...
void Foam::cyclicELLGAMGInterface::write(Ostream& os) const
{
    ELLGAMGInterface::write(os);
