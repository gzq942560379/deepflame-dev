...
namespace Foam
{
    defineTypeNameAndDebug(processorELLGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        ELLGAMGInterface,
        processorELLGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processorELLGAMGInterface::processorELLGAMGInterface
(
    const label index,
...
void Foam::processorELLGAMGInterface::initInternalFieldTransfer
(
...
Foam::tmp<Foam::labelField> Foam::processorELLGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes commsType,
    const labelUList& iF
) const
...
void Foam::processorELLGAMGInterface::write(Ostream& os) const
{
