...
namespace Foam
{
    defineTypeNameAndDebug(ELLGAMGInterface, 0);
    defineRunTimeSelectionTable(ELLGAMGInterface, lduInterface);
    defineRunTimeSelectionTable(ELLGAMGInterface, Istream);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::ELLGAMGInterface::ELLGAMGInterface
(
    const label index,
...
void Foam::ELLGAMGInterface::combine(const ELLGAMGInterface& coarseGi)
{
...
Foam::tmp<Foam::labelField> Foam::ELLGAMGInterface::interfaceInternalField
(
...
Foam::tmp<Foam::scalarField> Foam::ELLGAMGInterface::agglomerateCoeffs
(
...
void Foam::ELLGAMGInterface::write(Ostream& os) const
{
