...
namespace Foam
{
    defineTypeNameAndDebug(ELLPCG, 0);

    ellMatrix::solver::addsymMatrixConstructorToTable<ELLPCG>
        addELLPCGSymMatrixConstructorToTable_;
}
...
Foam::solverPerformance Foam::ELLPCG::solve
(
    scalarField& psi,
