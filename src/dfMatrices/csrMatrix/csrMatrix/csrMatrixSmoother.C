...
namespace Foam
{
    defineRunTimeSelectionTable(csrMatrix::smoother, symMatrix);
    defineRunTimeSelectionTable(csrMatrix::smoother, asymMatrix);
}

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

Foam::word
Foam::csrMatrix::smoother::getName
(
...
Foam::autoPtr<Foam::csrMatrix::smoother> Foam::csrMatrix::smoother::New
(
...
)
{
    ...
    else
    {
        ...
        return autoPtr<csrMatrix::smoother>(nullptr);
    }
}
...
Foam::csrMatrix::smoother::smoother
(
    const word& fieldName,
    const csrMatrix& matrix,
    const FieldField<Field, scalar>& interfaceBouCoeffs,
