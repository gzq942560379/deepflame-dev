...
#include "CSRGAMGProcAgglomeration.H"
#include "pairCSRGAMGAgglomeration.H"
#include "IOmanip.H"
...
namespace Foam
{
    defineTypeNameAndDebug(CSRGAMGAgglomeration, 0);
    defineRunTimeSelectionTable(CSRGAMGAgglomeration, lduMesh);
    defineRunTimeSelectionTable(CSRGAMGAgglomeration, lduMatrix);
    defineRunTimeSelectionTable(CSRGAMGAgglomeration, geometry);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::CSRGAMGAgglomeration::compactLevels(const label nCreatedLevels)
{
...
bool Foam::CSRGAMGAgglomeration::continueAgglomerating
(
...
Foam::CSRGAMGAgglomeration::CSRGAMGAgglomeration
(
    const lduMesh& mesh,
...
:
    ...
    (
      ...
      ? CSRGAMGProcAgglomeration::New
        (
            controlDict.lookup("processorAgglomerator"),
            *this,
            controlDict
        )
      : autoPtr<CSRGAMGProcAgglomeration>(nullptr)
    ),
...
const Foam::CSRGAMGAgglomeration& Foam::CSRGAMGAgglomeration::New
(
    const lduMesh& mesh,
    const dictionary& controlDict
)
{
    if
    (
        !mesh.thisDb().foundObject<CSRGAMGAgglomeration>
        (
    ...
    )
    {
        ...
        (
            controlDict,
            "geometricCSRGAMGAgglomerationLibs",
        ...
        if (cstrIter == lduMeshConstructorTablePtr_->end())
        {
            FatalErrorInFunction
                << "Unknown CSRGAMGAgglomeration type "
                << agglomeratorType << ".\n"
                << "Valid matrix CSRGAMGAgglomeration types are :"
                << lduMatrixConstructorTablePtr_->sortedToc() << endl
                << "Valid geometric CSRGAMGAgglomeration types are :"
    ...
    {
        return mesh.thisDb().lookupObject<CSRGAMGAgglomeration>
        (
            CSRGAMGAgglomeration::typeName
        );
    }
...
)
{
    ...
    )
    {
        ...
        (
            controlDict,
            "algebraicCSRGAMGAgglomerationLibs",
...
Foam::autoPtr<Foam::CSRGAMGAgglomeration> Foam::CSRGAMGAgglomeration::New
(
    const lduMesh& mesh,
...
)
{
    ...
    return autoPtr<CSRGAMGAgglomeration>
    (
        cstrIter()
        (
            mesh,
...
const Foam::lduMesh& Foam::CSRGAMGAgglomeration::meshLevel
(
    const label i
) const
{
...
bool Foam::CSRGAMGAgglomeration::hasMeshLevel(const label i) const
{
    if (i == 0)
    {
        return true;
...
const Foam::lduInterfacePtrsList& Foam::CSRGAMGAgglomeration::interfaceLevel
(
    const label i
) const
{
...
void Foam::CSRGAMGAgglomeration::clearLevel(const label i)
{
    if (hasMeshLevel(i))
    {
...
const Foam::labelList& Foam::CSRGAMGAgglomeration::procAgglomMap
(
    const label leveli
) const
{
...
const Foam::labelList& Foam::CSRGAMGAgglomeration::agglomProcIDs
(
    const label leveli
) const
{
...
bool Foam::CSRGAMGAgglomeration::hasProcMesh(const label leveli) const
{
    return procCommunicator_[leveli] != -1;
}


Foam::label Foam::CSRGAMGAgglomeration::procCommunicator(const label leveli) const
{
    return procCommunicator_[leveli];
}


const Foam::labelList& Foam::CSRGAMGAgglomeration::cellOffsets
(
    const label leveli
) const
{
...
const Foam::labelListList& Foam::CSRGAMGAgglomeration::faceMap
(
    const label leveli
) const
{
...
const Foam::labelListList& Foam::CSRGAMGAgglomeration::boundaryMap
(
    const label leveli
) const
{
...
const Foam::labelListListList& Foam::CSRGAMGAgglomeration::boundaryFaceMap
(
    const label leveli
) const
{
...
bool Foam::CSRGAMGAgglomeration::checkRestriction
(
