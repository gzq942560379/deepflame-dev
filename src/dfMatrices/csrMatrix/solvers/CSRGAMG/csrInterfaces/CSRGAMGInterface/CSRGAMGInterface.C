...
namespace Foam
{
    defineTypeNameAndDebug(CSRGAMGInterface, 0);
    defineRunTimeSelectionTable(CSRGAMGInterface, lduInterface);
    defineRunTimeSelectionTable(CSRGAMGInterface, Istream);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::CSRGAMGInterface::CSRGAMGInterface
(
    const label index,
...
void Foam::CSRGAMGInterface::combine(const CSRGAMGInterface& coarseGi)
{
...
Foam::tmp<Foam::labelField> Foam::CSRGAMGInterface::interfaceInternalField
(
...
Foam::tmp<Foam::scalarField> Foam::CSRGAMGInterface::agglomerateCoeffs
(
...
void Foam::CSRGAMGInterface::write(Ostream& os) const
{
