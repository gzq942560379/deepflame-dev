...
#include "cyclicCSRGAMGInterface.H"
...
namespace Foam
{
    defineTypeNameAndDebug(cyclicCSRGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        CSRGAMGInterface,
        cyclicCSRGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::cyclicCSRGAMGInterface::cyclicCSRGAMGInterface
(
    const label index,
...
:
    CSRGAMGInterface(index, coarseInterfaces),
    neighbPatchID_
    (
...
:
    CSRGAMGInterface(index, coarseInterfaces, is),
...
Foam::tmp<Foam::labelField> Foam::cyclicCSRGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes,
    const labelUList& iF
) const
{
    const cyclicCSRGAMGInterface& nbr = neighbPatch();
...
void Foam::cyclicCSRGAMGInterface::write(Ostream& os) const
{
    CSRGAMGInterface::write(os);
