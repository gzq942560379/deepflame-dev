...
namespace Foam
{
    defineTypeNameAndDebug(processorCSRGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        CSRGAMGInterface,
        processorCSRGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processorCSRGAMGInterface::processorCSRGAMGInterface
(
    const label index,
...
void Foam::processorCSRGAMGInterface::initInternalFieldTransfer
(
...
Foam::tmp<Foam::labelField> Foam::processorCSRGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes commsType,
    const labelUList& iF
) const
...
void Foam::processorCSRGAMGInterface::write(Ostream& os) const
{
