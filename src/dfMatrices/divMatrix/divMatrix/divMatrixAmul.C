...
// Foam::tmp<Foam::scalarField> Foam::divMatrix::residual
// (
//     const scalarField& psi,
//     const scalarField& source,
//     const FieldField<Field, scalar>& interfaceBouCoeffs,
...
// Foam::tmp<Foam::scalarField > Foam::divMatrix::H1() const
// {
//     tmp<scalarField > tH1
//     (
