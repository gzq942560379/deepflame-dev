...
namespace Foam
{
    defineRunTimeSelectionTable(divMatrix::smoother, symMatrix);
    defineRunTimeSelectionTable(divMatrix::smoother, asymMatrix);
}

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

Foam::word
Foam::divMatrix::smoother::getName
(
...
Foam::autoPtr<Foam::divMatrix::smoother> Foam::divMatrix::smoother::New
(
...
)
{
    ...
    else
    {
        ...
        return autoPtr<divMatrix::smoother>(nullptr);
    }
}
...
Foam::divMatrix::smoother::smoother
(
    const word& fieldName,
    const divMatrix& matrix,
    const FieldField<Field, scalar>& interfaceBouCoeffs,
