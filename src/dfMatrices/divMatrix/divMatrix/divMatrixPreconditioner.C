...
namespace Foam
{
    defineRunTimeSelectionTable(divMatrix::preconditioner, symMatrix);
    defineRunTimeSelectionTable(divMatrix::preconditioner, asymMatrix);
}


// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

Foam::word Foam::divMatrix::preconditioner::getName
(
...
Foam::autoPtr<Foam::divMatrix::preconditioner>
Foam::divMatrix::preconditioner::New
(
    const solver& sol,
    const dictionary& solverControls
)
{
    ...
    else
    {
        ...
        return autoPtr<divMatrix::preconditioner>(nullptr);
    }
}
