...
namespace Foam
{
    defineTypeNameAndDebug(DIVGAMGProcAgglomeration, 0);
    defineRunTimeSelectionTable(DIVGAMGProcAgglomeration, DIVGAMGAgglomeration);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::DIVGAMGProcAgglomeration::printStats
(
    Ostream& os,
    DIVGAMGAgglomeration& agglom
) const
{
...
Foam::labelListList Foam::DIVGAMGProcAgglomeration::globalCellCells
(
    const lduMesh& mesh
)
{
...
bool Foam::DIVGAMGProcAgglomeration::agglomerate
(
...
Foam::DIVGAMGProcAgglomeration::DIVGAMGProcAgglomeration
(
    DIVGAMGAgglomeration& agglom,
...
Foam::autoPtr<Foam::DIVGAMGProcAgglomeration> Foam::DIVGAMGProcAgglomeration::New
(
    const word& type,
    DIVGAMGAgglomeration& agglom,
    const dictionary& controlDict
)
{
    ...
    if (cstrIter == DIVGAMGAgglomerationConstructorTablePtr_->end())
    {
        FatalErrorInFunction
            << "Unknown DIVGAMGProcAgglomeration type "
            << type << " for DIVGAMGAgglomeration " << agglom.type() << nl << nl
            << "Valid DIVGAMGProcAgglomeration types are :" << endl
            << DIVGAMGAgglomerationConstructorTablePtr_->sortedToc()
            << exit(FatalError);
    }

    return autoPtr<DIVGAMGProcAgglomeration>(cstrIter()(agglom, controlDict));
}
