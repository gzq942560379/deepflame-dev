...
namespace Foam
{
    defineTypeNameAndDebug(processorDIVGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        DIVGAMGInterface,
        processorDIVGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processorDIVGAMGInterface::processorDIVGAMGInterface
(
    const label index,
...
void Foam::processorDIVGAMGInterface::initInternalFieldTransfer
(
...
Foam::tmp<Foam::labelField> Foam::processorDIVGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes commsType,
    const labelUList& iF
) const
...
void Foam::processorDIVGAMGInterface::write(Ostream& os) const
{
