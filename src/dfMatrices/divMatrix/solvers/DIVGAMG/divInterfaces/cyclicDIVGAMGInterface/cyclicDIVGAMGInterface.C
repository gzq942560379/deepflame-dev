...
#include "cyclicDIVGAMGInterface.H"
...
namespace Foam
{
    defineTypeNameAndDebug(cyclicDIVGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        DIVGAMGInterface,
        cyclicDIVGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::cyclicDIVGAMGInterface::cyclicDIVGAMGInterface
(
    const label index,
...
:
    DIVGAMGInterface(index, coarseInterfaces),
    neighbPatchID_
    (
...
:
    DIVGAMGInterface(index, coarseInterfaces, is),
...
Foam::tmp<Foam::labelField> Foam::cyclicDIVGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes,
    const labelUList& iF
) const
{
    const cyclicDIVGAMGInterface& nbr = neighbPatch();
...
void Foam::cyclicDIVGAMGInterface::write(Ostream& os) const
{
    DIVGAMGInterface::write(os);
