...
namespace Foam
{
    defineTypeNameAndDebug(DIVGAMGInterface, 0);
    defineRunTimeSelectionTable(DIVGAMGInterface, lduInterface);
    defineRunTimeSelectionTable(DIVGAMGInterface, Istream);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::DIVGAMGInterface::DIVGAMGInterface
(
    const label index,
...
void Foam::DIVGAMGInterface::combine(const DIVGAMGInterface& coarseGi)
{
...
Foam::tmp<Foam::labelField> Foam::DIVGAMGInterface::interfaceInternalField
(
...
Foam::tmp<Foam::scalarField> Foam::DIVGAMGInterface::agglomerateCoeffs
(
...
void Foam::DIVGAMGInterface::write(Ostream& os) const
{
