...
namespace Foam
{
    defineTypeNameAndDebug(processorDIVGAMGInterfaceField, 0);
    addToRunTimeSelectionTable
    (
        DIVGAMGInterfaceField,
        processorDIVGAMGInterfaceField,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processorDIVGAMGInterfaceField::processorDIVGAMGInterfaceField
(
...
:
    ...
    procInterface_(refCast<const processorDIVGAMGInterface>(GAMGCp)),
    doTransform_(false),
    rank_(0)
{
...
void Foam::processorDIVGAMGInterfaceField::initInterfaceMatrixUpdate
(
    scalarField&,
...
) const
{
    ...
    const_cast<processorDIVGAMGInterfaceField&>(*this).updatedMatrix() = false;
}


void Foam::processorDIVGAMGInterfaceField::updateInterfaceMatrix
(
    scalarField& result,
    const scalarField&,
...
) const
{
    ...
    )
    {
        ...
        // Recv finished so assume sending finished as wdiv.
    ...
    const_cast<processorDIVGAMGInterfaceField&>(*this).updatedMatrix() = true;
}
