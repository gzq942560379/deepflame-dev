...
Foam::autoPtr<Foam::DIVGAMGInterfaceField> Foam::DIVGAMGInterfaceField::New
(
...
)
{
    ...
    if (cstrIter == lduInterfaceFieldConstructorTablePtr_->end())
    {
        FatalErrorInFunction
            << "Unknown DIVGAMGInterfaceField type "
            << coupleType << nl
            << "Valid DIVGAMGInterfaceField types are :"
            << lduInterfaceFieldConstructorTablePtr_->sortedToc()
            << exit(FatalError);
    }

    return autoPtr<DIVGAMGInterfaceField>(cstrIter()(GAMGCp, fineInterface));
}
...
)
{
    ...
    return autoPtr<DIVGAMGInterfaceField>(cstrIter()(GAMGCp, doTransform, rank));
}
