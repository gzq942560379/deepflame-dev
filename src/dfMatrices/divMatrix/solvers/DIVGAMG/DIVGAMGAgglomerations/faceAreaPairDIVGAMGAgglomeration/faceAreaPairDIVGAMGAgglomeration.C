...
namespace Foam
{
    defineTypeNameAndDebug(faceAreaPairDIVGAMGAgglomeration, 0);

    addToRunTimeSelectionTable
    (
        DIVGAMGAgglomeration,
        faceAreaPairDIVGAMGAgglomeration,
        lduMesh
    );
...
Foam::faceAreaPairDIVGAMGAgglomeration::faceAreaPairDIVGAMGAgglomeration
(
    const lduMesh& mesh,
    const dictionary& controlDict
)
:
    pairDIVGAMGAgglomeration(mesh, controlDict)
{
