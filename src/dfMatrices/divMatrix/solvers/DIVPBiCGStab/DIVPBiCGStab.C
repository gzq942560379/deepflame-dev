...
// #define DIVPBiCGStab_solve_naive
// #define DIVPBiCGStab_solve_omp
#define DIVPBiCGStab_solve_no_norm

#if defined(DIVPBiCGStab_solve_naive)
...
) const
{
    ...
    PBiCGStab_norm_time += clock.timeIncrement();

    // --- Calculate normalised residual norm
    solverPerf.initialResidual() = gSumMag(rA, matrix().mesh().comm()) / normFactor;
    PBiCGStab_reduce_time += clock.timeIncrement();
...
#elif defined(DIVPBiCGStab_solve_omp)
...
#elif defined(DIVPBiCGStab_solve_no_norm)
