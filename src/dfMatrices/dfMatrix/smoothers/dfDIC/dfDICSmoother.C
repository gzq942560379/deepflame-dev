...
namespace Foam
{
    defineTypeNameAndDebug(dfDICSmoother, 0);

    dfMatrix::smoother::addsymMatrixConstructorToTable<dfDICSmoother>
        adddfDICSmootherSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::dfDICSmoother::dfDICSmoother
(
...
:
    ...
    rD_(matrix_.diag())
{
    dfDICPreconditioner::calcReciprocalD(rD_, matrix_);
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::dfDICSmoother::smooth
(
    scalarField& psi,
