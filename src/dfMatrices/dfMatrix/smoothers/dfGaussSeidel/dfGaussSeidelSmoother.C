...
#include "dfGaussSeidelSmoother.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(dfGaussSeidelSmoother, 0);

    dfMatrix::smoother::addsymMatrixConstructorToTable<dfGaussSeidelSmoother>
        adddfGaussSeidelSmootherSymMatrixConstructorToTable_;

    dfMatrix::smoother::addasymMatrixConstructorToTable<dfGaussSeidelSmoother>
        adddfGaussSeidelSmootherAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::dfGaussSeidelSmoother::dfGaussSeidelSmoother
(
...
void Foam::dfGaussSeidelSmoother::smooth
(
