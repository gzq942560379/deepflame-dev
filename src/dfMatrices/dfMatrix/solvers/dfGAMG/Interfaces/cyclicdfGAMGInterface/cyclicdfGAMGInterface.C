...
#include "cyclicdfGAMGInterface.H"
...
namespace Foam
{
    defineTypeNameAndDebug(cyclicdfGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        dfGAMGInterface,
        cyclicdfGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::cyclicdfGAMGInterface::cyclicdfGAMGInterface
(
    const label index,
...
:
    dfGAMGInterface(index, coarseInterfaces),
    neighbPatchID_
    (
...
:
    dfGAMGInterface(index, coarseInterfaces, is),
...
Foam::tmp<Foam::labelField> Foam::cyclicdfGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes,
    const labelUList& iF
) const
{
    const cyclicdfGAMGInterface& nbr = neighbPatch();
...
void Foam::cyclicdfGAMGInterface::write(Ostream& os) const
{
    dfGAMGInterface::write(os);
