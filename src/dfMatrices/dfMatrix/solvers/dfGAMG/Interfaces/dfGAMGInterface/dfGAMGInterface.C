...
namespace Foam
{
    defineTypeNameAndDebug(dfGAMGInterface, 0);
    defineRunTimeSelectionTable(dfGAMGInterface, lduInterface);
    defineRunTimeSelectionTable(dfGAMGInterface, Istream);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::dfGAMGInterface::dfGAMGInterface
(
    const label index,
...
void Foam::dfGAMGInterface::combine(const dfGAMGInterface& coarseGi)
{
...
Foam::tmp<Foam::labelField> Foam::dfGAMGInterface::interfaceInternalField
(
...
Foam::tmp<Foam::scalarField> Foam::dfGAMGInterface::agglomerateCoeffs
(
...
void Foam::dfGAMGInterface::write(Ostream& os) const
{
