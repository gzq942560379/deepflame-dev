...
namespace Foam
{
    defineTypeNameAndDebug(dfDILUPreconditioner, 0);

    dfMatrix::preconditioner::
        addasymMatrixConstructorToTable<dfDILUPreconditioner>
        adddfDILUPreconditionerAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::dfDILUPreconditioner::dfDILUPreconditioner
(
...
void Foam::dfDILUPreconditioner::calcReciprocalD
(
    scalarField& rD,
...
void Foam::dfDILUPreconditioner::precondition
(
    scalarField& wA,
...
void Foam::dfDILUPreconditioner::preconditionT
(
    scalarField& wT,
