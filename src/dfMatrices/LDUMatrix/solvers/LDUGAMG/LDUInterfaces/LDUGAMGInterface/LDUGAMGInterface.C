...
namespace Foam
{
    defineTypeNameAndDebug(LDUGAMGInterface, 0);
    defineRunTimeSelectionTable(LDUGAMGInterface, lduInterface);
    defineRunTimeSelectionTable(LDUGAMGInterface, Istream);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LDUGAMGInterface::LDUGAMGInterface
(
    const label index,
...
void Foam::LDUGAMGInterface::combine(const LDUGAMGInterface& coarseGi)
{
...
Foam::tmp<Foam::labelField> Foam::LDUGAMGInterface::interfaceInternalField
(
...
Foam::tmp<Foam::scalarField> Foam::LDUGAMGInterface::agglomerateCoeffs
(
...
void Foam::LDUGAMGInterface::write(Ostream& os) const
{
