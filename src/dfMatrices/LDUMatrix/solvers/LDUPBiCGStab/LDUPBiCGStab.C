...
namespace Foam
{
    defineTypeNameAndDebug(LDUPBiCGStab, 0);

    LDUMatrix::solver::addsymMatrixConstructorToTable<LDUPBiCGStab>
        addLDUPBiCGStabSymMatrixConstructorToTable_;

    LDUMatrix::solver::addasymMatrixConstructorToTable<LDUPBiCGStab>
        addLDUPBiCGStabAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LDUPBiCGStab::LDUPBiCGStab
(
...
Foam::solverPerformance Foam::LDUPBiCGStab::solve
(
    scalarField& psi,
...
) const
{
    ...
    Info << "Foam::LDUPBiCGStab::solve start -------------------------------------" << endl;
    ...
    Info << "Foam::LDUPBiCGStab::solve end --------------------------------------------" << endl;
    return solverPerf;
}
