...
#include "LDUDILUSmoother.H"
#include "LDUDILUPreconditioner.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(LDUDILUSmoother, 0);

    LDUMatrix::smoother::addasymMatrixConstructorToTable<LDUDILUSmoother>
        addLDUDILUSmootherAsymMatrixConstructorToTable_;
    LDUMatrix::smoother::addsymMatrixConstructorToTable<LDUDILUSmoother>
        addLDUDILUSmootherSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LDUDILUSmoother::LDUDILUSmoother
(
...
:
    ...
    rD_(matrix_.diag())
{
    LDUDILUPreconditioner::calcReciprocalD(rD_, matrix_);
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::LDUDILUSmoother::smooth
(
    scalarField& psi,
