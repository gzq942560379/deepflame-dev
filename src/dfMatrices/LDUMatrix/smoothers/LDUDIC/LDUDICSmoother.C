...
#include "LDUDICSmoother.H"
#include "LDUDICPreconditioner.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(LDUDICSmoother, 0);

    LDUMatrix::smoother::addsymMatrixConstructorToTable<LDUDICSmoother>
        addLDUDICSmootherSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LDUDICSmoother::LDUDICSmoother
(
...
:
    ...
    rD_(matrix_.diag())
{
    LDUDICPreconditioner::calcReciprocalD(rD_, matrix_);
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::LDUDICSmoother::smooth
(
    scalarField& psi,
