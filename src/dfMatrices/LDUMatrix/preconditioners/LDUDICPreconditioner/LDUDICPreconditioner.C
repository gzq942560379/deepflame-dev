...
namespace Foam
{
    defineTypeNameAndDebug(LDUDICPreconditioner, 0);

    LDUMatrix::preconditioner::
        addsymMatrixConstructorToTable<LDUDICPreconditioner>
        addLDUDICPreconditionerSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LDUDICPreconditioner::LDUDICPreconditioner
(
...
void Foam::LDUDICPreconditioner::calcReciprocalD
(
    scalarField& rD,
...
void Foam::LDUDICPreconditioner::precondition
(
    scalarField& wA,
