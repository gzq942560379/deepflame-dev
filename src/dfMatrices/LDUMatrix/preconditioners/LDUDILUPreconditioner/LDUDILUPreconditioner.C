...
namespace Foam
{
    defineTypeNameAndDebug(LDUDILUPreconditioner, 0);

    LDUMatrix::preconditioner::
        addasymMatrixConstructorToTable<LDUDILUPreconditioner>
        addLDUDILUPreconditionerAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LDUDILUPreconditioner::LDUDILUPreconditioner
(
...
void Foam::LDUDILUPreconditioner::calcReciprocalD
(
    scalarField& rD,
...
void Foam::LDUDILUPreconditioner::precondition
(
    scalarField& wA,
...
void Foam::LDUDILUPreconditioner::preconditionT
(
    scalarField& wT,
