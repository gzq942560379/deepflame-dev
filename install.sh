...
if [ ! -z "$USE_BLASDNN" ]; then
    ...
    # mkdir build
    # cd build
    # cmake .. -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx -DCMAKE_AR=/usr/sw/swgcc/swgcc710-tools-SEA-1307/usr/bin/swar -DCMAKE_CXX_FLAGS="-O3 -msimd -g -mftz -mieee" -DCMAKE_EXE_LINKER_FLAGS="-mhybrid" -DBLAS_LIBRARY="-L/home/export/online1/systest/jwl0122/guozhuoqiang/DeepFlame/software/xMath-SACA -lswblas"
    # make VERBOSE=1
    # mkdir -p $DF_ROOT/lib/
